...
public class BusPass {
    ...
    public int status;//1.requested 2.approved 3.suspended
    public String createdOn;

    public BusPass() {
    }

    public BusPass(int id, int uid, int routeId, String requestedOn, String approvedRejectedOn, String validTill, int status, String createdOn) {
        this.id = id;
        this.uid = uid;
